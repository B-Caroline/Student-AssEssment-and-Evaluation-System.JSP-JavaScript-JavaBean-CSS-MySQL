...
<%
    ...
    ResultSet rs = con.Query(
            "SELECT sc.scno,scname,score,sc.sno,NAME,student.cno,cname " +
                    "FROM course " +
...
<div>
    ...
    <div class="article">
        <br><br>
        <center>
            <span><font face="宋体" size="6"><strong>查询到该课程的学生及成绩如下：</strong></font></span>
            <table border="2" cellspacing="5" cellpadding="13" class="form3">
                <%try{ %>
                <thead>
                <tr>
                    <th>课程编号</th>
