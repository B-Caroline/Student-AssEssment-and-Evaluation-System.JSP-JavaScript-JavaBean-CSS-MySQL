...
<%
    stu con = new stu();
    ResultSet rs = con.Query("select * from course");
%>
...
<div>
    <div class="aside">
        ...
        <div class="article">
            <br>
            <form name="form3.3" action="Index_Man_Insert_cou.jsp" method="post">
                <center>
                    <div>
                        <input type="text" name="scno" placeholder="需要添加的课程编号*" required>
                    </div>
                    <div>
            ...
            <center>
                <span><font face="宋体" size="6"><strong>所有开设的课程信息</strong></font></span>
