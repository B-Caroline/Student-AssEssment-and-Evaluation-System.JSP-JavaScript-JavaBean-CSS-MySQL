...
<%
    stu con = new stu();
    ResultSet rs = con.Query("select * from class");
%>
...
<div>
    ...
    <div class="article">
        <br>
        <form name="form3.3" action="Index_Man_Insert_class.jsp" method="post">
            <center>
                <div>
                    <input type="text" name="cno" placeholder="需要添加的班级编号*" required>
                </div>
                <div>
        ...
        <center>
            <span><font face="宋体" size="6"><strong>所有班级信息</strong></font></span>
            <table border="2" cellspacing="5" cellpadding="10" class="form3">
                <%try{ %>
                <thead>
                <tr>
                    <th>班级编号</th>
                ...
                <tbody>
                <tr>
                    <td height="15"><%=rs.getString(1) %></td>
                    <td height="15"><%=rs.getString(2) %></td>
                    <td height="15"><%=rs.getString(3) %></td>
                    <td height="15"><%=rs.getString(4) %></td>
                </tr>
                </tbody>
                <%
                        }
