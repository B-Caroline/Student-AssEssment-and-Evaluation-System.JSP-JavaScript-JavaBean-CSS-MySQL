...
<div>
    ...
    <div class="article">
        <br>
        <form name="form3.1" action="Index_Man_Update_stu.jsp" method="post">
            <center>
                <div>
                    <input type="text" name="sno" placeholder="请输入需要更新的学生学号*" required>
                </div>
                <div>
        ...
        <center>
            <span><font face="宋体" size="6"><strong>学生综合信息如下：</strong></font></span>
