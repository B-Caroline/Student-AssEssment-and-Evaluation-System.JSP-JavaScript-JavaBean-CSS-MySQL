...
<div>
    ...
    <div class="article">
        <br>
        <form name="form3.4" action="Index_Man_Delete_Tea.jsp" method="post">
            <center>
                <div>
                    <input type="text" name="tno" placeholder="需要删除的教师编号*" required>
                </div>
                <div>
        ...
        <center>
            <span><font face="宋体" size="5"><strong>教师综合信息</strong></font></span>
