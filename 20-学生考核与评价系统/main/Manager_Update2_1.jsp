...
<jsp:useBean id="db_man" class="bean.Managers" scope="session"/>
    <%
    stu con = new stu();
    ResultSet rs = con.Query("select * from teacher");
%>
<body>
<div class="head">
    <div id="Head_Title">
...
<div>
    ...
    <div class="article">
        <br>
            <form name="form3.3" action="Index_Man_Update_tea.jsp" method="post">
                <center>
                    <div>
                        <input type="text" name="tno" placeholder="请需要更新的教师编号*" required>
                    </div>
                    <div>
            ...
            <center>
                <span><font face="宋体" size="6"><strong>教师综合信息如下：</strong></font></span>
