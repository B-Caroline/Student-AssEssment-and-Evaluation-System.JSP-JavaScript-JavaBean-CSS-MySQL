...
<div>
    ...
    <div class="article">
        <form name="form3.2" action="Manager_Update1_3.jsp" method="post">
            <center>
                <div id="page" style="position:relative;">
                    <div class="#">
                        <span class="#">更新学生信息</span>
                    </div>
                    <div class="#">
                        <div class="#">
                            <table width="100%" border="1" cellpadding="0" cellspacing="30" style="margin-left:10px;">
                                <tr>
                                    <td>学号：</td>
                                    <td><input name="sno" value="<%=db_stu.getSno()%>" style="width:300px;height:30px;border:1px solid #ccc;" readonly /></td>
                                </tr>
                                <tr>
                                    <td>姓名：</td>
                                    <td><input name="name" value="<%=db_stu.getName()%>" style="width:300px;height:30px;border:1px solid #ccc;" required /></td>
                                </tr>
                                <tr>
                                    <td>密码：</td>
                                    <td><input name="password" value="<%=db_stu.getPassword()%>" style="width:300px;height:30px;border:1px solid #ccc;" required /></td>
                                </tr>
                                <tr>
                                    <td>性别：</td>
                                ...
                                <tr>
                                    <td>年龄：</td>
                                    <td><input name="age" value="<%=db_stu.getAge()%>" style="width:300px;height:30px;border:1px solid #ccc;" required /></td>
                                </tr>
                                <tr>
                                    <td>课程号：</td>
                                    <td><input name="cno" value="<%=db_stu.getCno()%>" style="width:300px;height:30px;border:1px solid #ccc;" required /></td>
                                </tr>
                                <tr>
                                    <td>联系电话：</td>
