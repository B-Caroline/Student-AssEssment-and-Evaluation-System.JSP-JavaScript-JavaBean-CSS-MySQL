...
<div>
    ...
    <div class="article">
        <br>
            <center>
                <span><font face="宋体" size="5"><strong>查询到学号为<%=db_delete_stu.getSno()%>的学生综合信息如下：</strong></font></span>
                <table border="3" cellspacing="5" cellpadding="10" class="form3">
                    ...
                    <tbody>
                    <tr>
                        <td height="30"><%=db_delete_stu.getSno() %></td>
                        <td height="30"><%=db_delete_stu.getName() %></td>
                        <td height="30"><%=db_delete_stu.getPassword() %></td>
                        <td height="30"><%=db_delete_stu.getAge() %></td>
                        <td height="30"><%=db_delete_stu.getSex() %></td>
                        <td height="30"><%=db_delete_stu.getTel() %></td>
                        <td height="30"><%=db_delete_stu.getCno() %></td>
                        <td height="30"><%=db_delete_stu.getEmail() %></td>
                        <td height="30"><%=db_delete_stu.getAddress() %></td>
                    </tr>
                    </tbody>
                </table>
            </center>
            <br><br>
            <center><a href="Manager_Delete1_3.jsp">确认删除</a> </center>
        </div>
</div>
