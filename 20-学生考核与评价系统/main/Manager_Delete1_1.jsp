...
<div>
    ...
    <div class="article">
        <br>
        <form name="form3.3" action="Index_Man_Delete_Stu.jsp" method="post">
            <center>
                <div>
                    <input type="text" name="sno" placeholder="需要删除的学生学号*" required>
                </div>
                <div>
        ...
        <center>
            <caption><font face="宋体" size="5"><strong>学生综合信息</strong></font></caption>
            <table border="3" cellspacing="5" cellpadding="7" class="form3">
                <%try{ %>
                <thead>
                <tr>
                    <th>学号</th>
