...
<div>
    ...
    <div class="article">
        <form name="form3.2" action="Manager_Insert2_3.jsp" method="post">
            <center>
                <div id="page" style="position:relative;">
                    <div class="#">
                        <span class="#">新增教师综合信息</span>
                    </div>
                    <div class="#">
                        <div class="#">
                            <table width="100%" border="1" cellpadding="0" cellspacing="30" style="margin-left:10px;">
                                <tr>
                                    <td>教师编号：</td>
                                    <td><input name="tno" value="<%=request.getParameter("tno")%>" style="width:300px;height:30px;border:1px solid #ccc;" readonly /></td>
                                </tr>
                                <tr>
                                    <td>姓名：</td>
                                    <td><input name="tname" type="text" style="width:300px;height:30px;border:1px solid #ccc;" required /></td>
                                </tr>
                                <tr>
                                    <td>密码：</td>
