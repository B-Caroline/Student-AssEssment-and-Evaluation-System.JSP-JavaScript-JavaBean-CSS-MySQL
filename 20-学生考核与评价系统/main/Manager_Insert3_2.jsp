...
<!--管理员-->
<head>
    <title>添加新的课程信息02</title>
    <link rel="shortcut icon" href="../jpg/icon/course.ico" type="image/vnd.microsoft.icon">
</head>
<style type="text/css">
...
<div>
    ...
    <div class="article">
        <br><br>
        <form name="form3.5" action="Manager_Insert3_3.jsp" method="post">
            <center>
                <div id="page" style="position:relative;">
                    <div class="#">
                        <span class="#">新增课程信息</span>
                    </div>
                    <div class="#">
                        <div class="#">
                            <table width="100%" border="1" cellpadding="0" cellspacing="30" style="margin-left:10px;">
                                <tr>
                                    <td>课程编号：</td>
                                    <td><input name="scno" value="<%=request.getParameter("scno")%>" type="text" style="width:300px;height:30px;border:1px solid #ccc;" readonly /></td>
                                </tr>
                                <tr>
                                    <td>课程名称：</td>
                                    <td><input name="scname" type="text" style="width:300px;height:30px;border:1px solid #ccc;" required /></td>
                                </tr>
                                <tr>
                                    <td>教师编号：</td>
