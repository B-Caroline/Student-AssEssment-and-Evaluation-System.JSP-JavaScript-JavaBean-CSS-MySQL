...
<div>
    ...
    <div class="article">
        <br><br>
        <form name="form2.3" action="Teacher_Insert1_3.jsp" method="post">
            <center>
                <div id="page" style="position:relative;">
                    <div class="#">
                        <span class="#">添加学号为<%=sno%>学生的<%=scno%>学科的成绩</span>
                    </div>
                    <div class="#">
                        <div class="#">
                            <table width="100%" border="1" cellpadding="0" cellspacing="30" style="margin-left:10px;">
                                <tr>
                                    <td>课程号：</td>
                                    <td><input name="scno" value="<%=scno%>" type="text" style="width:300px;height:30px;border:1px solid #ccc;" readonly /><span>（不允许修改）</span></td>
                                </tr>
                                <tr>
                                    <td>学号：</td>
                                    <td><input name="sno" value="<%=sno%>" type="text" style="width:300px;height:30px;border:1px solid #ccc;" readonly /><span>（不允许修改）</span></td>
                                </tr>
                                <tr>
                                    <td>成绩：</td>
                                    <td><input name="score" type="text" style="width:300px; height:30px;border:1px solid #ccc;" required /></td>
                                </tr>
                            </table>
                        </div>
                        <div class="#">
