...
<div>
    ...
    <div class="article">
        <br>
            <form name="form3.5" action="Index_Man_Insert_tea.jsp" method="post">
                <center>
                    <div>
                        <input type="text" name="tno" placeholder="需要新增的教师编号*" required>
                    </div>
                    <div>
            ...
            <center>
                <span><font face="宋体" size="6"><strong>教师综合信息</strong></font></span>
