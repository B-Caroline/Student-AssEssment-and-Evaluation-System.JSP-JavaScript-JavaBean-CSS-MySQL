...
<!--管理员-->
<head>
    <title>教师综合信息首页</title>
    <link rel="shortcut icon" href="../jpg/icon/teacher.ico" type="image/vnd.microsoft.icon">
</head>
<style type="text/css">
...
<div>
    ...
    <div class="article">
        <br>
        <center>
            <span><font face="宋体" size="6"><strong>查询到教师综合信息如下：</strong></font></span>
